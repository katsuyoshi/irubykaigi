...
- (UITableViewController *)tableViewController
{
    ...
    controller.day = [[[document days] objectAtIndex:0] valueForKey:@"date"];
    return controller;
}
...
{
    ASSERT_EQUAL_INT(9, NUMBER_OF_SECTIONS());
    ...
    ASSERT_EQUAL_INT(7, NUMBER_OF_ROWS_IN_SECTION(3));
    ...
    ASSERT_EQUAL_INT(1, NUMBER_OF_ROWS_IN_SECTION(8));
    ...
    cell = CELL(0, 2);
    ASSERT_EQUAL(@"休憩", cell.textLabel.text);
